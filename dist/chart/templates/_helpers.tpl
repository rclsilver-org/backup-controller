...
*/}}
{{- define "backup-controller.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "backup-controller.resourceName" -}}
{{- $fullname := include "backup-controller.fullname" .context }}
{{- $suffix := .suffix }}
...
{{- else }}
{{- include "backup-controller.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
